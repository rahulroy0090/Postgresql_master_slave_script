...
echo "archive_command = 'cp %p /var/lib/postgresql/repl/%f'" >> "${CONF_PATH}/postgresql.conf"
echo "max_wal_senders = 10" >> "${CONF_PATH}/postgresql.conf"
echo "wal_keep_size = 16" >> "${CONF_PATH}/postgresql.conf"
echo "synchronous_standby_names = 'slave'" >> "${CONF_PATH}/postgresql.conf"
echo "hot_standby = on" >> "${CONF_PATH}/postgresql.conf"
...
# Check the status of the master and slave container
podman ps
